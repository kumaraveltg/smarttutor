            ...
            {rows.map((row) => (
              <tr key={row.chapter_id} className="border-t border-slate-100">
                ...
                <td className="px-4 py-2 space-x-2">
                  <Link to={`/admin/chapter/${row.chapter_id}`} className="text-brand-600 hover:underline">
                    Edit
                  </Link>
                  <button onClick={() => handleDelete(row.chapter_id)} className="text-red-600 hover:underline">
                    Delete
                  </button>
                </td>
              </tr>
